    ...
    <div className="p-5 bg-white shadow-sm border h-screen">
      ...
      <div className="mt-5">
        {menu.map((item, index) => (
          <div
            key={index}
            className="group flex gap-3 mt-2 p-3 text-[18px] items-center text-gray-500 cursor-pointer hover:bg-primary hover:text-white rounded-lg transition-all ease-in-out duration-200"
          >
